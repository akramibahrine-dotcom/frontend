...
> = {
  SAR: { labelAr: "ريال سعودي", labelEn: "Saudi Riyal", symbol: "ر.س", locale: "ar-SA", fractionDigits: 0 },
  ...
  AED: { labelAr: "درهم إماراتي", labelEn: "UAE Dirham", symbol: "د.إ", locale: "ar-AE", fractionDigits: 0 },
  ...
  QAR: { labelAr: "ريال قطري", labelEn: "Qatari Riyal", symbol: "ر.ق", locale: "ar-QA", fractionDigits: 0 },
  EGP: { labelAr: "جنيه مصري", labelEn: "Egyptian Pound", symbol: "ج.م", locale: "ar-EG", fractionDigits: 0 },
  ...
  MAD: { labelAr: "درهم مغربي", labelEn: "Moroccan Dirham", symbol: "د.م", locale: "ar-MA", fractionDigits: 0 },
  TND: { labelAr: "دينار تونسي", labelEn: "Tunisian Dinar", symbol: "د.ت", locale: "ar-TN", fractionDigits: 2 },
  TRY: { labelAr: "ليرة تركية", labelEn: "Turkish Lira", symbol: "₺", locale: "tr-TR", fractionDigits: 0 },
  PKR: { labelAr: "روبية باكستانية", labelEn: "Pakistani Rupee", symbol: "₨", locale: "ur-PK", fractionDigits: 0 },
  INR: { labelAr: "روبية هندية", labelEn: "Indian Rupee", symbol: "₹", locale: "hi-IN", fractionDigits: 0 },
  ...
  CNY: { labelAr: "يوان صيني", labelEn: "Chinese Yuan", symbol: "¥", locale: "zh-CN", fractionDigits: 0 },
  ...
  DZD: { labelAr: "دينار جزائري", labelEn: "Algerian Dinar", symbol: "د.ج", locale: "ar-DZ", fractionDigits: 0 },
  ...
  NGN: { labelAr: "نيرة نيجيرية", labelEn: "Nigerian Naira", symbol: "₦", locale: "en-NG", fractionDigits: 0 },
};
