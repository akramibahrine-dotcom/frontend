...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      <h1 className="text-3xl font-extrabold text-[#1C1C1E] mb-8">سياسة الخصوصية</h1>

      <div className="prose prose-sm max-w-none text-[#3D3D3D] leading-relaxed space-y-6">
        <section>
          <h2 className="text-lg font-bold text-[#1C1C1E] mb-2">البيانات التي نجمعها</h2>
        ...
        <section>
          <h2 className="text-lg font-bold text-[#1C1C1E] mb-2">لماذا نجمع هذه البيانات</h2>
          <ul className="list-disc list-inside space-y-1">
        ...
        <section>
          <h2 className="text-lg font-bold text-[#1C1C1E] mb-2">التتبع من جهة الخادم</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-[#1C1C1E] mb-2">ملفات تعريف الارتباط (Cookies)</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-[#1C1C1E] mb-2">حفظ البيانات وأمانها</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-[#1C1C1E] mb-2">حقوقك</h2>
          <p>
        ...
        <div className="bg-[#FAFAF8] border border-[#E8E0D4] rounded-xl p-4 text-sm">
          <p>
            منتجات بيت الصحة هي شاي عشبي داعم للعافية اليومية وليست أدوية. للاستفسارات، تواصلي معنا عبر صفحة التواصل.
          </p>
        </div>
      </div>
    </div>
