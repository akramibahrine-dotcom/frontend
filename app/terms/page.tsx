...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      <h1 className="text-3xl font-extrabold text-[#1C1C1E] mb-8">الشروط والأحكام</h1>

      <div className="space-y-6 text-[#3D3D3D] leading-relaxed">
        <section>
          <h2 className="text-lg font-bold text-[#1C1C1E] mb-2">طبيعة المنتجات</h2>
          <p>
            منتجات بيت الصحة هي شاي عشبي داعم للعافية اليومية وليست أدوية ولا بديلًا عن الاستشارة الطبية. لا تُستخدم لتشخيص أو علاج أو الوقاية من أي مرض.
          </p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-[#1C1C1E] mb-2">شروط الطلب</h2>
        ...
        <section>
          <h2 className="text-lg font-bold text-[#1C1C1E] mb-2">إخلاء المسؤولية</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-[#1C1C1E] mb-2">تعديل الشروط</h2>
          <p>
