      ...
      <div className="max-w-[1200px] mx-auto px-4 py-8 lg:py-12 grid grid-cols-1 lg:grid-cols-4 gap-4 lg:gap-8">
        ...
        <div className="mb-6 lg:mb-0">
          <div className="mb-4 flex items-center gap-2">
            <div className="w-9 h-9 rounded-full bg-[#C99A45] text-[#071C12] flex items-center justify-center font-bold text-base flex-shrink-0">
              ن
            </div>
        ...
        <FooterSection title={COPY.footer.trustTitle}>
          <ul className="space-y-3 text-sm text-[#FFFFFF]/70 mb-6">
            ...
            <li className="flex items-center gap-2"><span>🚚</span> توصيل داخل السعودية</li>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="#" className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#C99A45] hover:text-[#071C12] text-[#C99A45] transition-all duration-300 hover:scale-110" aria-label="TikTok">
              ...
              <a href="#" className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#C99A45] hover:text-[#071C12] text-[#C99A45] transition-all duration-300 hover:scale-110" aria-label="Instagram">
