...
const MINI_REVIEWS: Record<string, MiniReview[]> = {
  ...
  "weight-support-tea": [
    { name: "سعود المطيري", flag: "🇸🇦", city: "الرياض", age: 30, quote: "نزلت 14 كيلو بدون حرمان! هالشاي غيّر حياتي والله.", badge: "◈ -14 كغ" },
  ...
  // Same short reviews as weight-support-tea
  "bloom-coffee": [
    { name: "سعود المطيري", flag: "🇸🇦", city: "الرياض", age: 30, quote: "نزلت 14 كيلو بدون حرمان! هالشاي غيّر حياتي والله.", badge: "◈ -14 كغ" },
    { name: "نورة الشمري", flag: "🇸🇦", city: "جدة", age: 28, quote: "بعد الولادة وزني زاد كثير، واليوم رجعت لوزني الطبيعي. مشكورين!", badge: "◆ هدف متحقق" },
    { name: "أحمد العنزي", flag: "🇰🇼", city: "الكويت", age: 35, quote: "كنت أحس بثقل دائم، الشاي خفف وزني وحسّن نشاطي بشكل ملحوظ.", badge: "◆ نشاط وحيوية" },
  ...
  "lung-smoking-support-tea": [
    { name: "يوسف الشهري", flag: "🇸🇦", city: "الرياض", age: 32, quote: "تركت التدخين وهالشاي ساعدني أنظف رئتي. أتنفس أحسن بكثير.", badge: "◇ تنفس أفضل" },
  ...
  "c60-fullerene-serum": [
    { name: "مريم البلوشي", flag: "🇴🇲", city: "مسقط", age: 34, quote: "بعد أسبوعين بشرتي صارت ألين والخطوط حول العين خفّت بشكل ملحوظ.", badge: "✦ نعومة واضحة" },
    { name: "فاطمة الراشدي", flag: "🇴🇲", city: "نزوى", age: 29, quote: "أستخدمها قبل النوم كل يوم — الترطيب ثابت ولوني صار أوضح.", badge: "◇ ترطيب عميق" },
    { name: "شيخة السيابي", flag: "🇴🇲", city: "مسقط", age: 26, quote: "خفيف ويمتص بسرعة. البقع الغامقة خفّت بعد 3 أسابيع تقريباً.", badge: "✧ مناسب للدهنية" },
    { name: "نورة الهنائي", flag: "🇴🇲", city: "عبري", age: 32, quote: "أفضل من كريمات غالية جربتها — بشرتي مشدودة وإشراقة الصبح واضحة.", badge: "◇ أفضل من الكريمات" },
    { name: "سعيد الحارثي", flag: "🇴🇲", city: "صلالة", age: 41, quote: "بعد شهر جارات زوجتي سألوها شو مسوية لبشرتها — النتيجة واضحة.", badge: "★ الكل لاحظ" },
  ],
};
