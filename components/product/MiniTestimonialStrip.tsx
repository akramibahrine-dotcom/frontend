...
const MINI_REVIEWS: Record<string, MiniReview[]> = {
  ...
  "bloom-coffee": [
    { name: "سارة العتيبي", flag: "🇸🇦", city: "الرياض", age: 29, quote: "قهوة بلوم صارت روتيني اليومي — خفيفة على المعدة وحسّيت بنشاط أوضح.", badge: "◈ روتين يومي" },
    { name: "فهد الشمري", flag: "🇸🇦", city: "جدة", age: 34, quote: "بعد الأكل ما عاد أحس بنفس الثقل. والطعم ممتاز صدق!", badge: "◆ هضم أهدأ" },
    { name: "نورة الكندري", flag: "🇰🇼", city: "الكويت", age: 27, quote: "بدّلت قهوتي العادية ببلوم… فرق واضح في الراحة والالتزام.", badge: "✦ بديل ذكي" },
    { name: "أحمد البلوشي", flag: "🇴🇲", city: "مسقط", age: 31, quote: "تدعم الوزن وتهضّم أحسن — وما أقدر أستغني عنها الصباح.", badge: "◆ طاقة خفيفة" },
  ],
  "colon-comfort-tea": [
