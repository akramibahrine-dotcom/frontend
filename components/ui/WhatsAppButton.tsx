  ...
  return (
    <div className="fixed bottom-24 right-4 z-40 flex flex-col items-center gap-2 group md:bottom-8 md:right-8">
      ...
      <button 
        ...
        className="opacity-0 group-hover:opacity-100 transition-opacity bg-black/50 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs absolute -top-8"
