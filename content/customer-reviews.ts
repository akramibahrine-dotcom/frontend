...
export const CUSTOMER_REVIEWS: CustomerReview[] = [
  ...
  {
    id: "r16",
    nameAr: "سلطان الغامدي",
    countryAr: "🇸🇦 جدة",
    gender: "man",
    portraitFile: "/reviews/r16-sultan.jpg",
    sceneLabelAr: "في البيت",
    sceneEmoji: "🏠",
    quoteAr: "جل الندوب هذا شي ثاني! ندبة عملية على يدي من سنتين صارت بالكاد تنشاف بعد شهر ونص. شكراً بيت الصحة على المنتج الممتاز.",
    rating: 5,
  },
  {
    id: "r17",
    ...
    countryAr: "🇦🇪 دبي",
    gender: "woman",
    portraitFile: "/reviews/r17-manal.jpg",
    sceneLabelAr: "بالبيت",
    sceneEmoji: "🏡",
    quoteAr: "استخدمت جل السيليكون على آثار حروق قديمة وصراحة النتيجة فاقت توقعاتي. خفيف وما يهيّج البشرة. أنصح كل حد يجربه!",
    rating: 5,
  },
  {
    id: "r18",
    ...
    countryAr: "🇶🇦 الدوحة",
    gender: "man",
    portraitFile: "/reviews/r18-yousef.jpg",
    sceneLabelAr: "بالمكتب",
    sceneEmoji: "💼",
    quoteAr: "كنت محتار بين منتجات كثيرة للندوب. طلبت هذا الجل والحمدلله ندبة الوجه خفّت بشكل ملحوظ. منتج أصلي وفعّال.",
    rating: 5,
  },
];
