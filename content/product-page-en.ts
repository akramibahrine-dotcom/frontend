...
export const PAGE_UI = {
  ar: {
    ...
    thankYouStep1Title: "مكالمة المستشار",
    thankYouStep1Desc: "نكلّمك للإجابة على أسئلتك ومساعدتك في أفضل حل لمشكلتك — ثم نؤكّد الطلب",
    thankYouStep2Title: "التجهيز والشحن",
    thankYouStep2Desc: "بعد تأكيدك نجهّز طلبك بعناية ونشحنه لعنوانك بأسرع وقت ممكن",
  ...
  en: {
    ...
    thankYouTotal: "Total",
    thankYouStep1Title: "Advisor call",
    thankYouStep1Desc: "We call to answer your questions, help with the best solution for your concern, then confirm the order",
    thankYouStep2Title: "Preparation & shipping",
    thankYouStep2Desc: "After you confirm, we carefully prepare and ship your order as fast as possible",
