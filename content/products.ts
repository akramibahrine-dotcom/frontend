export type ImageTheme = "weight" | "colon" | "hemorrhoid" | "liver" | "lung" | "prostate";
    ...
    faq: [
      {
        ...
        answer:
          "لا. هو شاي عشبي لدعم عافيتك اليومية ضمن أسلوب حياة متوازن؛ ليس وصفة طبية ولا بديلًا لمتابعة مختص.",
      },
      {
        question: "متى أشربه؟",
      ...
      },
      {
        ...
        answer:
          "نوصل داخل المملكة، ويُرجى التأكيد مع فريقنا قبل التجهيز — دفعك عندما يصلك الطلب.",
      },
    ],
  },
  {
    ...
    imageTheme: "colon",
    images: ["/products/colon-comfort-tea/1.webp", "/products/colon-comfort-tea/2.webp", "/products/colon-comfort-tea/3.jpg"],
